...
export class PropertyMappingRadius extends pulumi.CustomResource {
  ...
  public readonly propertyMappingRadiusId!: pulumi.Output<string>;
  ...
  constructor(
    name: string,
    argsOrState?: PropertyMappingRadiusArgs | PropertyMappingRadiusState,
    opts?: pulumi.CustomResourceOptions,
  ) {
    ...
    if (opts.id) {
      ...
      resourceInputs["propertyMappingRadiusId"] = state ? state.propertyMappingRadiusId : undefined;
    } else {
      ...
      resourceInputs["propertyMappingRadiusId"] = args ? args.propertyMappingRadiusId : undefined;
    }

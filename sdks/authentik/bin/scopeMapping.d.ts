...
export declare class ScopeMapping extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScopeMappingState, opts?: pulumi.CustomResourceOptions): ScopeMapping;
    /**
     * Returns true if the given object is an instance of ScopeMapping.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ScopeMapping;
    readonly description: pulumi.Output<string | undefined>;
    readonly expression: pulumi.Output<string>;
    readonly name: pulumi.Output<string>;
    readonly scopeMappingId: pulumi.Output<string>;

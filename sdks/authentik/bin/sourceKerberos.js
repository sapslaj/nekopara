...
class SourceKerberos extends pulumi.CustomResource {
  ...
  constructor(name, argsOrState, opts) {
    ...
    if (opts.id) {
      ...
      resourceInputs["spnegoKeytab"] = (args === null || args === void 0 ? void 0 : args.spnegoKeytab)
        ? pulumi.secret(args.spnegoKeytab)
        : undefined;
      ...
      resourceInputs["syncKeytab"] = (args === null || args === void 0 ? void 0 : args.syncKeytab)
        ? pulumi.secret(args.syncKeytab)
        : undefined;
      resourceInputs["syncPassword"] = (args === null || args === void 0 ? void 0 : args.syncPassword)

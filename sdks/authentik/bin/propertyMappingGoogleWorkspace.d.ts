...
export declare class PropertyMappingGoogleWorkspace extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PropertyMappingGoogleWorkspaceState, opts?: pulumi.CustomResourceOptions): PropertyMappingGoogleWorkspace;
    /**
     ...
     */
    static isInstance(obj: any): obj is PropertyMappingGoogleWorkspace;
    readonly expression: pulumi.Output<string>;
    readonly name: pulumi.Output<string>;
    readonly propertyMappingGoogleWorkspaceId: pulumi.Output<string>;
    /**

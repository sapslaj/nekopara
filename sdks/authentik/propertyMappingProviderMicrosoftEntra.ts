...
export class PropertyMappingProviderMicrosoftEntra extends pulumi.CustomResource {
  ...
  public readonly propertyMappingProviderMicrosoftEntraId!: pulumi.Output<string>;
  ...
  constructor(
    name: string,
    argsOrState?: PropertyMappingProviderMicrosoftEntraArgs | PropertyMappingProviderMicrosoftEntraState,
    opts?: pulumi.CustomResourceOptions,
  ) {
    ...
    if (opts.id) {
      ...
      resourceInputs["propertyMappingProviderMicrosoftEntraId"] = state
        ? state.propertyMappingProviderMicrosoftEntraId
        : undefined;
    } else {
      ...
      resourceInputs["propertyMappingProviderMicrosoftEntraId"] = args
        ? args.propertyMappingProviderMicrosoftEntraId
        : undefined;
    }
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    super(
      PropertyMappingProviderMicrosoftEntra.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/

...
export class PropertyMappingLdap extends pulumi.CustomResource {
  ...
  public readonly propertyMappingLdapId!: pulumi.Output<string>;
  ...
  constructor(
    name: string,
    argsOrState?: PropertyMappingLdapArgs | PropertyMappingLdapState,
    opts?: pulumi.CustomResourceOptions,
  ) {
    ...
    if (opts.id) {
      ...
      resourceInputs["propertyMappingLdapId"] = state ? state.propertyMappingLdapId : undefined;
    } else {
      ...
      resourceInputs["propertyMappingLdapId"] = args ? args.propertyMappingLdapId : undefined;
    }

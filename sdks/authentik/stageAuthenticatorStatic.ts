...
export class StageAuthenticatorStatic extends pulumi.CustomResource {
  ...
  public readonly stageAuthenticatorStaticId!: pulumi.Output<string>;
  /**
   * Defaults to `6`.
   */
  ...
  constructor(
    name: string,
    argsOrState?: StageAuthenticatorStaticArgs | StageAuthenticatorStaticState,
    opts?: pulumi.CustomResourceOptions,
  ) {
    ...
    if (opts.id) {
      ...
      resourceInputs["stageAuthenticatorStaticId"] = state ? state.stageAuthenticatorStaticId : undefined;
      ...
      resourceInputs["stageAuthenticatorStaticId"] = args ? args.stageAuthenticatorStaticId : undefined;
    ...
    super(
      StageAuthenticatorStatic.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/

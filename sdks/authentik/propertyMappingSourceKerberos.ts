...
export class PropertyMappingSourceKerberos extends pulumi.CustomResource {
  ...
  public readonly propertyMappingSourceKerberosId!: pulumi.Output<string>;
  ...
  constructor(
    name: string,
    argsOrState?: PropertyMappingSourceKerberosArgs | PropertyMappingSourceKerberosState,
    opts?: pulumi.CustomResourceOptions,
  ) {
    ...
    if (opts.id) {
      ...
      resourceInputs["propertyMappingSourceKerberosId"] = state ? state.propertyMappingSourceKerberosId : undefined;
    } else {
      ...
      resourceInputs["propertyMappingSourceKerberosId"] = args ? args.propertyMappingSourceKerberosId : undefined;
    }
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    super(
      PropertyMappingSourceKerberos.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/

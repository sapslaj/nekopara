...
export class StageConsent extends pulumi.CustomResource {
  ...
  public readonly stageConsentId!: pulumi.Output<string>;
  ...
  constructor(name: string, argsOrState?: StageConsentArgs | StageConsentState, opts?: pulumi.CustomResourceOptions) {
    ...
    if (opts.id) {
      ...
      resourceInputs["stageConsentId"] = state ? state.stageConsentId : undefined;
    } else {
      ...
      resourceInputs["stageConsentId"] = args ? args.stageConsentId : undefined;
    }

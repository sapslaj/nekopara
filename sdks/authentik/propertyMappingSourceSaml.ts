...
export class PropertyMappingSourceSaml extends pulumi.CustomResource {
  ...
  public readonly propertyMappingSourceSamlId!: pulumi.Output<string>;
  ...
  constructor(
    name: string,
    argsOrState?: PropertyMappingSourceSamlArgs | PropertyMappingSourceSamlState,
    opts?: pulumi.CustomResourceOptions,
  ) {
    ...
    if (opts.id) {
      ...
      resourceInputs["propertyMappingSourceSamlId"] = state ? state.propertyMappingSourceSamlId : undefined;
    } else {
      ...
      resourceInputs["propertyMappingSourceSamlId"] = args ? args.propertyMappingSourceSamlId : undefined;
    }
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    super(
      PropertyMappingSourceSaml.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/

...
export class PropertyMappingGoogleWorkspace extends pulumi.CustomResource {
  ...
  public readonly propertyMappingGoogleWorkspaceId!: pulumi.Output<string>;
  ...
  constructor(
    name: string,
    argsOrState?: PropertyMappingGoogleWorkspaceArgs | PropertyMappingGoogleWorkspaceState,
    opts?: pulumi.CustomResourceOptions,
  ) {

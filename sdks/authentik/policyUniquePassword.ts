...
export class PolicyUniquePassword extends pulumi.CustomResource {
   ...
   * Defaults to `1`.
   */
  public readonly numHistoricalPasswords!: pulumi.Output<number | undefined>;
  /**
   * Defaults to `password`.
   */
  public readonly passwordField!: pulumi.Output<string | undefined>;
  public readonly policyUniquePasswordId!: pulumi.Output<string>;
  ...
  constructor(
    name: string,
    argsOrState?: PolicyUniquePasswordArgs | PolicyUniquePasswordState,
    opts?: pulumi.CustomResourceOptions,
  ) {

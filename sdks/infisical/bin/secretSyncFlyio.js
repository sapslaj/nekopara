...
exports.SecretSyncFlyio = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretSyncFlyio extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretSyncFlyio(name, state, { ...opts, id: id });
  }
  /**
...
/** @internal */
SecretSyncFlyio.__pulumiType = "infisical:index/secretSyncFlyio:SecretSyncFlyio";
// # sourceMappingURL=secretSyncFlyio.js.map

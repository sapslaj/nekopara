...
exports.SecretSyncGcpSecretManager = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretSyncGcpSecretManager extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretSyncGcpSecretManager(name, state, { ...opts, id: id });
  }
  /**
  ...
  constructor(name, argsOrState, opts) {
    ...
    super(
      SecretSyncGcpSecretManager.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/
...
/** @internal */
SecretSyncGcpSecretManager.__pulumiType = "infisical:index/secretSyncGcpSecretManager:SecretSyncGcpSecretManager";
// # sourceMappingURL=secretSyncGcpSecretManager.js.map

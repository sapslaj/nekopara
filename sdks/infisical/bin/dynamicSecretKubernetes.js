...
exports.DynamicSecretKubernetes = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class DynamicSecretKubernetes extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new DynamicSecretKubernetes(name, state, { ...opts, id: id });
  }
  /**
  ...
  constructor(name, argsOrState, opts) {
    ...
    super(
      DynamicSecretKubernetes.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/
...
/** @internal */
DynamicSecretKubernetes.__pulumiType = "infisical:index/dynamicSecretKubernetes:DynamicSecretKubernetes";
// # sourceMappingURL=dynamicSecretKubernetes.js.map

...
exports.SecretSyncAzureKeyVault = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretSyncAzureKeyVault extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretSyncAzureKeyVault(name, state, { ...opts, id: id });
  }
  /**
  ...
  constructor(name, argsOrState, opts) {
    ...
    super(
      SecretSyncAzureKeyVault.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/
...
/** @internal */
SecretSyncAzureKeyVault.__pulumiType = "infisical:index/secretSyncAzureKeyVault:SecretSyncAzureKeyVault";
// # sourceMappingURL=secretSyncAzureKeyVault.js.map

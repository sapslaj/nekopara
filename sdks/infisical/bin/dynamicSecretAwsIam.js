...
exports.DynamicSecretAwsIam = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class DynamicSecretAwsIam extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new DynamicSecretAwsIam(name, state, { ...opts, id: id });
  }
  /**
...
/** @internal */
DynamicSecretAwsIam.__pulumiType = "infisical:index/dynamicSecretAwsIam:DynamicSecretAwsIam";
// # sourceMappingURL=dynamicSecretAwsIam.js.map

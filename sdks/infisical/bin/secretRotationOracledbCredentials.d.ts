...
export declare class SecretRotationOracledbCredentials extends pulumi.CustomResource {
  /**
  ...
  static get(
    ...
    state?: SecretRotationOracledbCredentialsState,
   ...
   */
  static isInstance(obj: any): obj is SecretRotationOracledbCredentials;
  /**
   ...
   */
  readonly parameters: pulumi.Output<outputs.SecretRotationOracledbCredentialsParameters>;
  /**
   ...
   */
  readonly rotateAtUtc: pulumi.Output<outputs.SecretRotationOracledbCredentialsRotateAtUtc>;
  /**
   ...
   */
  readonly secretsMapping: pulumi.Output<outputs.SecretRotationOracledbCredentialsSecretsMapping>;
  /**
   * Temporary parameters to modify how secrets are rotated.
   */
  readonly temporaryParameters: pulumi.Output<outputs.SecretRotationOracledbCredentialsTemporaryParameters | undefined>;
  /**

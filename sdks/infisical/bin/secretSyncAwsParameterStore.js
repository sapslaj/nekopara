...
exports.SecretSyncAwsParameterStore = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretSyncAwsParameterStore extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretSyncAwsParameterStore(name, state, { ...opts, id: id });
  }
  /**
  ...
  constructor(name, argsOrState, opts) {
    ...
    super(
      SecretSyncAwsParameterStore.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/
...
/** @internal */
SecretSyncAwsParameterStore.__pulumiType = "infisical:index/secretSyncAwsParameterStore:SecretSyncAwsParameterStore";
// # sourceMappingURL=secretSyncAwsParameterStore.js.map

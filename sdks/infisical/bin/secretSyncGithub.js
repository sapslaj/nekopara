...
exports.SecretSyncGithub = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretSyncGithub extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretSyncGithub(name, state, { ...opts, id: id });
  }
  /**
...
/** @internal */
SecretSyncGithub.__pulumiType = "infisical:index/secretSyncGithub:SecretSyncGithub";
// # sourceMappingURL=secretSyncGithub.js.map

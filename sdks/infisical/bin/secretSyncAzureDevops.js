...
exports.SecretSyncAzureDevops = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretSyncAzureDevops extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretSyncAzureDevops(name, state, { ...opts, id: id });
  }
  /**
...
/** @internal */
SecretSyncAzureDevops.__pulumiType = "infisical:index/secretSyncAzureDevops:SecretSyncAzureDevops";
// # sourceMappingURL=secretSyncAzureDevops.js.map

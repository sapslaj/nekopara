...
exports.AppConnectionGcp = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class AppConnectionGcp extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new AppConnectionGcp(name, state, { ...opts, id: id });
  }
  /**
...
/** @internal */
AppConnectionGcp.__pulumiType = "infisical:index/appConnectionGcp:AppConnectionGcp";
// # sourceMappingURL=appConnectionGcp.js.map

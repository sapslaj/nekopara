...
exports.SecretApprovalPolicy = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretApprovalPolicy extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretApprovalPolicy(name, state, { ...opts, id: id });
  }
  /**
...
/** @internal */
SecretApprovalPolicy.__pulumiType = "infisical:index/secretApprovalPolicy:SecretApprovalPolicy";
// # sourceMappingURL=secretApprovalPolicy.js.map

...
export declare class SecretRotationPostgresCredentials extends pulumi.CustomResource {
  /**
  ...
  static get(
    ...
    state?: SecretRotationPostgresCredentialsState,
   ...
   */
  static isInstance(obj: any): obj is SecretRotationPostgresCredentials;
  /**
   ...
   */
  readonly parameters: pulumi.Output<outputs.SecretRotationPostgresCredentialsParameters>;
  /**
   ...
   */
  readonly rotateAtUtc: pulumi.Output<outputs.SecretRotationPostgresCredentialsRotateAtUtc>;
  /**
   ...
   */
  readonly secretsMapping: pulumi.Output<outputs.SecretRotationPostgresCredentialsSecretsMapping>;
  /**
   * Temporary parameters to modify how secrets are rotated.
   */
  readonly temporaryParameters: pulumi.Output<outputs.SecretRotationPostgresCredentialsTemporaryParameters | undefined>;
  /**

...
exports.SecretRotationOracledbCredentials = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretRotationOracledbCredentials extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretRotationOracledbCredentials(name, state, { ...opts, id: id });
  }
  /**
...
// # sourceMappingURL=secretRotationOracledbCredentials.js.map

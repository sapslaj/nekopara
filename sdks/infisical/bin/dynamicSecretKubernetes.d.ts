...
export declare class DynamicSecretKubernetes extends pulumi.CustomResource {
  /**
  ...
  static get(
    ...
    state?: DynamicSecretKubernetesState,
   ...
   */
  static isInstance(obj: any): obj is DynamicSecretKubernetes;
  /**
   * The configuration of the dynamic secret
   */
  readonly configuration: pulumi.Output<outputs.DynamicSecretKubernetesConfiguration>;
  /**
   ...
   */
  readonly metadatas: pulumi.Output<outputs.DynamicSecretKubernetesMetadata[] | undefined>;
  /**

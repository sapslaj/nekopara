...
exports.AppConnectionPostgres = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class AppConnectionPostgres extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new AppConnectionPostgres(name, state, { ...opts, id: id });
  }
  /**
...
/** @internal */
AppConnectionPostgres.__pulumiType = "infisical:index/appConnectionPostgres:AppConnectionPostgres";
// # sourceMappingURL=appConnectionPostgres.js.map

...
exports.SecretSync1password = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretSync1password extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretSync1password(name, state, { ...opts, id: id });
  }
  /**
...
/** @internal */
SecretSync1password.__pulumiType = "infisical:index/secretSync1password:SecretSync1password";
// # sourceMappingURL=secretSync1password.js.map

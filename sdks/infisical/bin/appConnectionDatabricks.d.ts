...
export declare class AppConnectionDatabricks extends pulumi.CustomResource {
  /**
  ...
  static get(
    ...
    state?: AppConnectionDatabricksState,
    opts?: pulumi.CustomResourceOptions,
  ): AppConnectionDatabricks;
  /**
   * Returns true if the given object is an instance of AppConnectionDatabricks.  This is designed to work even
   * when multiple copies of the Pulumi SDK have been loaded into the same process.
   */
  static isInstance(obj: any): obj is AppConnectionDatabricks;
  /**
   * The credentials for the Databricks App Connection
   */
  readonly credentials: pulumi.Output<outputs.AppConnectionDatabricksCredentials>;
  /**

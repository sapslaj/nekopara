...
exports.SecretSyncCloudflareWorkers = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretSyncCloudflareWorkers extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretSyncCloudflareWorkers(name, state, { ...opts, id: id });
  }
  /**
  ...
  constructor(name, argsOrState, opts) {
    ...
    super(
      SecretSyncCloudflareWorkers.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/
...
/** @internal */
SecretSyncCloudflareWorkers.__pulumiType = "infisical:index/secretSyncCloudflareWorkers:SecretSyncCloudflareWorkers";
// # sourceMappingURL=secretSyncCloudflareWorkers.js.map

...
export declare class SecretRotationAwsIamUserSecret extends pulumi.CustomResource {
  /**
  ...
  static get(
    ...
    state?: SecretRotationAwsIamUserSecretState,
    opts?: pulumi.CustomResourceOptions,
  ): SecretRotationAwsIamUserSecret;
  /**
   ...
   */
  static isInstance(obj: any): obj is SecretRotationAwsIamUserSecret;
  /**
   ...
   */
  readonly parameters: pulumi.Output<outputs.SecretRotationAwsIamUserSecretParameters>;
  /**
   ...
   */
  readonly rotateAtUtc: pulumi.Output<outputs.SecretRotationAwsIamUserSecretRotateAtUtc>;
  /**
   ...
   */
  readonly secretsMapping: pulumi.Output<outputs.SecretRotationAwsIamUserSecretSecretsMapping>;
  /**
   * Temporary parameters to modify how secrets are rotated.
   */
  readonly temporaryParameters: pulumi.Output<outputs.SecretRotationAwsIamUserSecretTemporaryParameters | undefined>;
  /**

...
exports.SecretSyncAwsSecretsManager = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretSyncAwsSecretsManager extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretSyncAwsSecretsManager(name, state, { ...opts, id: id });
  }
  /**
  ...
  constructor(name, argsOrState, opts) {
    ...
    super(
      SecretSyncAwsSecretsManager.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/
...
/** @internal */
SecretSyncAwsSecretsManager.__pulumiType = "infisical:index/secretSyncAwsSecretsManager:SecretSyncAwsSecretsManager";
// # sourceMappingURL=secretSyncAwsSecretsManager.js.map

...
exports.SecretSyncAzureAppConfiguration = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretSyncAzureAppConfiguration extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretSyncAzureAppConfiguration(name, state, { ...opts, id: id });
  }
  /**
  ...
  constructor(name, argsOrState, opts) {
    ...
    super(
      SecretSyncAzureAppConfiguration.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/
...
// # sourceMappingURL=secretSyncAzureAppConfiguration.js.map

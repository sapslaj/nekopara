...
export declare class AppConnectionPostgres extends pulumi.CustomResource {
  /**
  ...
  static get(
    ...
    state?: AppConnectionPostgresState,
    opts?: pulumi.CustomResourceOptions,
  ): AppConnectionPostgres;
  /**
   * Returns true if the given object is an instance of AppConnectionPostgres.  This is designed to work even
   * when multiple copies of the Pulumi SDK have been loaded into the same process.
   */
  static isInstance(obj: any): obj is AppConnectionPostgres;
  /**
   * The credentials for the PostgreSQL App Connection
   */
  readonly credentials: pulumi.Output<outputs.AppConnectionPostgresCredentials>;
  /**

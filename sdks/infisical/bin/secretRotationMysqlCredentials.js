...
exports.SecretRotationMysqlCredentials = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretRotationMysqlCredentials extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretRotationMysqlCredentials(name, state, { ...opts, id: id });
  }
  /**
  ...
  constructor(name, argsOrState, opts) {
    ...
    super(
      SecretRotationMysqlCredentials.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/
...
// # sourceMappingURL=secretRotationMysqlCredentials.js.map

...
exports.AppConnectionDatabricks = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class AppConnectionDatabricks extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new AppConnectionDatabricks(name, state, { ...opts, id: id });
  }
  /**
  ...
  constructor(name, argsOrState, opts) {
    ...
    super(
      AppConnectionDatabricks.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/
...
/** @internal */
AppConnectionDatabricks.__pulumiType = "infisical:index/appConnectionDatabricks:AppConnectionDatabricks";
// # sourceMappingURL=appConnectionDatabricks.js.map

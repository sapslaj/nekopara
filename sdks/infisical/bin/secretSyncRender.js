...
exports.SecretSyncRender = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretSyncRender extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretSyncRender(name, state, { ...opts, id: id });
  }
  /**
...
/** @internal */
SecretSyncRender.__pulumiType = "infisical:index/secretSyncRender:SecretSyncRender";
// # sourceMappingURL=secretSyncRender.js.map

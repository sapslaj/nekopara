...
exports.SecretRotationLdapPassword = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretRotationLdapPassword extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretRotationLdapPassword(name, state, { ...opts, id: id });
  }
  /**
  ...
  constructor(name, argsOrState, opts) {
    ...
    super(
      SecretRotationLdapPassword.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/
...
/** @internal */
SecretRotationLdapPassword.__pulumiType = "infisical:index/secretRotationLdapPassword:SecretRotationLdapPassword";
// # sourceMappingURL=secretRotationLdapPassword.js.map

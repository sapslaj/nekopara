...
exports.SecretSyncSupabase = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretSyncSupabase extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretSyncSupabase(name, state, { ...opts, id: id });
  }
  /**
...
/** @internal */
SecretSyncSupabase.__pulumiType = "infisical:index/secretSyncSupabase:SecretSyncSupabase";
// # sourceMappingURL=secretSyncSupabase.js.map

...
export declare class SecretSyncGithub extends pulumi.CustomResource {
  /**
   ...
   */
  static isInstance(obj: any): obj is SecretSyncGithub;
  /**
   ...
   */
  readonly destinationConfig: pulumi.Output<outputs.SecretSyncGithubDestinationConfig>;
  /**
   ...
   */
  readonly syncOptions: pulumi.Output<outputs.SecretSyncGithubSyncOptions>;
  /**

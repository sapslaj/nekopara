...
exports.SecretRotationMssqlCredentials = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretRotationMssqlCredentials extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretRotationMssqlCredentials(name, state, { ...opts, id: id });
  }
  /**
...
// # sourceMappingURL=secretRotationMssqlCredentials.js.map

...
exports.AppConnectionMssql = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class AppConnectionMssql extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new AppConnectionMssql(name, state, { ...opts, id: id });
  }
  /**
...
/** @internal */
AppConnectionMssql.__pulumiType = "infisical:index/appConnectionMssql:AppConnectionMssql";
// # sourceMappingURL=appConnectionMssql.js.map

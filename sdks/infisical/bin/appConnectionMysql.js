...
exports.AppConnectionMysql = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class AppConnectionMysql extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new AppConnectionMysql(name, state, { ...opts, id: id });
  }
  /**
...
/** @internal */
AppConnectionMysql.__pulumiType = "infisical:index/appConnectionMysql:AppConnectionMysql";
// # sourceMappingURL=appConnectionMysql.js.map

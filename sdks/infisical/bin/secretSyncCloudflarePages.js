...
exports.SecretSyncCloudflarePages = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class SecretSyncCloudflarePages extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new SecretSyncCloudflarePages(name, state, { ...opts, id: id });
  }
  /**
  ...
  constructor(name, argsOrState, opts) {
    ...
    super(
      SecretSyncCloudflarePages.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/
...
/** @internal */
SecretSyncCloudflarePages.__pulumiType = "infisical:index/secretSyncCloudflarePages:SecretSyncCloudflarePages";
// # sourceMappingURL=secretSyncCloudflarePages.js.map

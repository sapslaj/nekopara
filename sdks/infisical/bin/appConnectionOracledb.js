...
exports.AppConnectionOracledb = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class AppConnectionOracledb extends pulumi.CustomResource {
  /**
  ...
  static get(name, id, state, opts) {
    return new AppConnectionOracledb(name, state, { ...opts, id: id });
  }
  /**
...
/** @internal */
AppConnectionOracledb.__pulumiType = "infisical:index/appConnectionOracledb:AppConnectionOracledb";
// # sourceMappingURL=appConnectionOracledb.js.map

...
export declare class SecretRotationMssqlCredentials extends pulumi.CustomResource {
  /**
  ...
  static get(
    ...
    state?: SecretRotationMssqlCredentialsState,
    opts?: pulumi.CustomResourceOptions,
  ): SecretRotationMssqlCredentials;
  /**
   ...
   */
  static isInstance(obj: any): obj is SecretRotationMssqlCredentials;
  /**
   ...
   */
  readonly parameters: pulumi.Output<outputs.SecretRotationMssqlCredentialsParameters>;
  /**
   ...
   */
  readonly rotateAtUtc: pulumi.Output<outputs.SecretRotationMssqlCredentialsRotateAtUtc>;
  /**
   ...
   */
  readonly secretsMapping: pulumi.Output<outputs.SecretRotationMssqlCredentialsSecretsMapping>;
  /**
   * Temporary parameters to modify how secrets are rotated.
   */
  readonly temporaryParameters: pulumi.Output<outputs.SecretRotationMssqlCredentialsTemporaryParameters | undefined>;
  /**

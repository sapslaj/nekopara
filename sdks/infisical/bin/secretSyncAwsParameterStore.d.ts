...
export declare class SecretSyncAwsParameterStore extends pulumi.CustomResource {
  /**
  ...
  static get(
    ...
    state?: SecretSyncAwsParameterStoreState,
    opts?: pulumi.CustomResourceOptions,
  ): SecretSyncAwsParameterStore;
  /**
   ...
   */
  static isInstance(obj: any): obj is SecretSyncAwsParameterStore;
  /**
   ...
   */
  readonly destinationConfig: pulumi.Output<outputs.SecretSyncAwsParameterStoreDestinationConfig>;
  /**
   ...
   */
  readonly syncOptions: pulumi.Output<outputs.SecretSyncAwsParameterStoreSyncOptions>;
  /**

...
export declare class SecretSyncCloudflareWorkers extends pulumi.CustomResource {
  /**
  ...
  static get(
    ...
    state?: SecretSyncCloudflareWorkersState,
    opts?: pulumi.CustomResourceOptions,
  ): SecretSyncCloudflareWorkers;
  /**
   ...
   */
  static isInstance(obj: any): obj is SecretSyncCloudflareWorkers;
  /**
   ...
   */
  readonly destinationConfig: pulumi.Output<outputs.SecretSyncCloudflareWorkersDestinationConfig>;
  /**
   ...
   */
  readonly syncOptions: pulumi.Output<outputs.SecretSyncCloudflareWorkersSyncOptions>;
  /**

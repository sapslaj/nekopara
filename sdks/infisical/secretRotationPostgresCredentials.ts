...
export class SecretRotationPostgresCredentials extends pulumi.CustomResource {
  ...
  declare public readonly temporaryParameters: pulumi.Output<
    outputs.SecretRotationPostgresCredentialsTemporaryParameters | undefined
  >;
  ...
  constructor(
    name: string,
    argsOrState?: SecretRotationPostgresCredentialsArgs | SecretRotationPostgresCredentialsState,
    opts?: pulumi.CustomResourceOptions,
  ) {
    ...
    super(
      SecretRotationPostgresCredentials.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/

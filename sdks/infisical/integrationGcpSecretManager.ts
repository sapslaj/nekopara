...
export class IntegrationGcpSecretManager extends pulumi.CustomResource {
   ...
   */
  declare public readonly /*out*/ integrationAuthId: pulumi.Output<string>;
  /**
   * The ID of the integration, used internally by Infisical.
   */
  declare public readonly /*out*/ integrationId: pulumi.Output<string>;
  /**
   * Integration options
   */
  ...
  constructor(
    name: string,
    argsOrState?: IntegrationGcpSecretManagerArgs | IntegrationGcpSecretManagerState,
    opts?: pulumi.CustomResourceOptions,
  ) {

...
export class IdentityUniversalAuthClientSecret extends pulumi.CustomResource {
   ...
   */
  declare public readonly /*out*/ clientId: pulumi.Output<string>;
  /**
   * The client secret.
   */
  declare public readonly /*out*/ clientSecret: pulumi.Output<string>;
  /**
   ...
   */
  declare public readonly /*out*/ isRevoked: pulumi.Output<boolean>;
  /**
   * The number of times that the client secret is used
   */
  declare public readonly /*out*/ numberOfUses: pulumi.Output<number>;
  /**
  ...
  constructor(
    name: string,
    argsOrState?: IdentityUniversalAuthClientSecretArgs | IdentityUniversalAuthClientSecretState,
    opts?: pulumi.CustomResourceOptions,
  ) {

...
export class SecretRotationOracledbCredentials extends pulumi.CustomResource {
  ...
  declare public readonly temporaryParameters: pulumi.Output<
    outputs.SecretRotationOracledbCredentialsTemporaryParameters | undefined
  >;
  ...
  constructor(
    name: string,
    argsOrState?: SecretRotationOracledbCredentialsArgs | SecretRotationOracledbCredentialsState,
    opts?: pulumi.CustomResourceOptions,
  ) {
    ...
    super(
      SecretRotationOracledbCredentials.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/

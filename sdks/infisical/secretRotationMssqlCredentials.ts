...
export class SecretRotationMssqlCredentials extends pulumi.CustomResource {
  ...
  declare public readonly temporaryParameters: pulumi.Output<
    outputs.SecretRotationMssqlCredentialsTemporaryParameters | undefined
  >;
  ...
  constructor(
    name: string,
    argsOrState?: SecretRotationMssqlCredentialsArgs | SecretRotationMssqlCredentialsState,
    opts?: pulumi.CustomResourceOptions,
  ) {
    ...
    super(
      SecretRotationMssqlCredentials.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/

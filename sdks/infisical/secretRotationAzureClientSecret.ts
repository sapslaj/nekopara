...
export class SecretRotationAzureClientSecret extends pulumi.CustomResource {
  ...
  declare public readonly temporaryParameters: pulumi.Output<
    outputs.SecretRotationAzureClientSecretTemporaryParameters | undefined
  >;
  ...
  constructor(
    name: string,
    argsOrState?: SecretRotationAzureClientSecretArgs | SecretRotationAzureClientSecretState,
    opts?: pulumi.CustomResourceOptions,
  ) {
    ...
    super(
      SecretRotationAzureClientSecret.__pulumiType,
      name,
      resourceInputs,
      opts,
      false, /*dependency*/

...
export class SecretRotationAwsIamUserSecret extends pulumi.CustomResource {
   ...
   */
  declare public readonly temporaryParameters: pulumi.Output<
    outputs.SecretRotationAwsIamUserSecretTemporaryParameters | undefined
  >;
  ...
  constructor(
    name: string,
    argsOrState?: SecretRotationAwsIamUserSecretArgs | SecretRotationAwsIamUserSecretState,
    opts?: pulumi.CustomResourceOptions,
  ) {

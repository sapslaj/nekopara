...
export class ProjectIdentitySpecificPrivilege extends pulumi.CustomResource {
   ...
   */
  declare public readonly permissionsV2s: pulumi.Output<
    outputs.ProjectIdentitySpecificPrivilegePermissionsV2[] | undefined
  >;
  /**
  ...
  constructor(
    name: string,
    argsOrState?: ProjectIdentitySpecificPrivilegeArgs | ProjectIdentitySpecificPrivilegeState,
    opts?: pulumi.CustomResourceOptions,
  ) {

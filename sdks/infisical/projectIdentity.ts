...
export class ProjectIdentity extends pulumi.CustomResource {
   ...
   */
  declare public readonly /*out*/ identity: pulumi.Output<outputs.ProjectIdentityIdentity>;
  /**
   ...
   */
  declare public readonly /*out*/ membershipId: pulumi.Output<string>;
  /**
  ...
  constructor(
    name: string,
    argsOrState?: ProjectIdentityArgs | ProjectIdentityState,
    opts?: pulumi.CustomResourceOptions,
  ) {
